...
// У цьому фрагменті коду оголошені три змінні з різними типами
// значень: текст, число і булеве значення.

console.log("Задача 1. Типізація скалярних значень (файл task-1.ts)");
